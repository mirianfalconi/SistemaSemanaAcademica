...
!function (a) {
  ...
  a.fn.extend({
    caret: function (a, b) {
      ...
      }))  : (this[0].setSelectionRange ? (a = this[0].selectionStart, b = this[0].selectionEnd)  : document.selection && document.selection.createRange && (c = document.selection.createRange(), a = 0 - c.duplicate().moveStart('character', - 100000), b = a + c.text.length), {
        begin: a,
        end: b
      })
    },
...
$(document).ready(function () {
  ...
  $('#faculdade').bind('keyup blur',function(){
    var node = $(this);
    node.val(node.val().replace(/[^A-Za-z ]/g,'') ); }
  );
  $('#instituicao').bind('keyup blur',function(){
    var node = $(this);
    node.val(node.val().replace(/[^A-Za-z ]/g,'') ); }
  );
});
